...
//*icons
final String devicesIcon = _getIconPath("devices.png");
final String gadgetsIcon = _getIconPath("gadgets.png");
final String gameIcon = _getIconPath("game.png");
final String menIcon = _getIconPath("men.png");
